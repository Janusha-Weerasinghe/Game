...
$db_host = 'localhost';
$db_name = 'game_arcade'; // Your database name
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Extract and sanitize the time taken from the request
    $timeTaken = filter_var($_POST['timeTaken'], FILTER_SANITIZE_NUMBER_INT);

    // Prepare and execute the SQL query to insert the player's name, answers, and time taken into the database
    $stmt = $conn->prepare("INSERT INTO shortest_path_winner (PlayerName, Answer1, Answer2, Answer3, Answer4, Answer5, Answer6, Answer7, Answer8, Answer9, Answer10, TimeTaken) 
                            VALUES (:playerName, :answer1, :answer2, :answer3, :answer4, :answer5, :answer6, :answer7, :answer8, :answer9, :answer10, :timeTaken)");
